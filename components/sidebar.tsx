...
const navigationItems = [
  ...
  },
  {
    ...
    icon: Shield,
    color: "text-red-400",
    path: "/dashboard/defense-obligations/regulations",
    subItems: [
      { name: "Regulations", path: "/dashboard/defense-obligations/regulations" },
      { name: "Audit & Assurance", path: "/dashboard/defense-obligations/audit-assurance" },
      { name: "Risk & Governance", path: "/dashboard/defense-obligations/risk-governance" },
      { name: "Best Practices", path: "/dashboard/defense-obligations/best-practices" },
    ],
  },
  {
    id: 5,
    ...
    path: "/dashboard/people-organization",
    subItems: [],
  },
  {
    id: 6,
    ...
    path: "/dashboard/technology-data",
    subItems: [],
  },
  {
    id: 7,
